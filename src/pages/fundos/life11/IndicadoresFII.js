...
const IndicadoresFII = ({ dados }) => {
  ...
  const indicadores = [
    ...
    { 
      ...
      info: "A taxa de Performance é de 20% sobre o que exceder 100% do CDI."
    },
    { 
      label: "Valor Administração (R$)", 
      value: dados.valorAdm.toLocaleString("pt-BR", { style: "currency", currency: "BRL" }),
      info: "A taxa de Administração é de 1,38% a.a."
    }
  ];

  return (
    <div className="indicadores-container">
      <h3 className="indicadores-title">Indicadores do FII</h3>
